  ...
  return (
    <section id="about" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* ── LEFT COLUMN: FOUNDER PORTRAIT (Lg: 5 cols) ── */}
        <div className="lg:col-span-5 space-y-6">
          <div className="glass-card rounded-3xl p-5 sm:p-6 border-2 border-[#C9A84C]/40 bg-gradient-to-b from-[#0B1120] via-[#05080F] to-[#030712] relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_30px_rgba(201,168,76,0.15)] group">
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] border-2 border-[#C9A84C]/40 shadow-2xl bg-[#080B14]">
              <img
                src="/founder.jpg"
                alt="Ricardo Gutierrez - Founder & Systems Architect"
                className="w-full h-full object-cover object-top"
                onError={(e) => {
                  // Fallback if founder.jpg is missing
              ...
              {/* Fallback Icon Container if image not found */}
              <div className="photo-fallback hidden absolute inset-0 bg-[#080B14] flex flex-col items-center justify-center text-center p-6">
                <div className="w-20 h-20 rounded-2xl bg-[#C9A84C]/10 border border-[#C9A84C]/30 flex items-center justify-center text-[#E8D5A3] mb-4">
                  <User className="w-10 h-10 text-[#C9A84C]" />
                </div>
                <span className="font-aquire text-sm font-bold text-[#EDF0F5] uppercase">Ricardo Gutierrez</span>
                <span className="text-xs font-mono text-[#8B9BB4] mt-1">Founder & Systems Architect</span>
              </div>
            ...
            <div className="mt-5 pt-4 border-t border-white/10 space-y-2.5 text-xs font-mono">
              <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-[#05080F] border border-white/5 text-[#CBD5E1]">
          ...
          <div className="glass-card rounded-3xl p-8 sm:p-10 md:p-12 border border-[#C9A84C]/30 bg-gradient-to-b from-[#0B1120] via-[#05080F] to-[#030712] relative overflow-hidden shadow-2xl">
            ...
            <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl overflow-hidden border-2 border-[#C9A84C] shadow-lg shadow-[#C9A84C]/20 shrink-0 bg-[#080B14]">
                  <img
                    src="/founder.jpg"
